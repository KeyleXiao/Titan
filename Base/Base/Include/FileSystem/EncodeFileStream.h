//==========================================================================
/**
* @file	  : EncodeFileStream.h
* @author : PeakGao <peakgao163@163.com>
* created : 2011-8-2   16:16
* purpose : 用于加密和压缩了的文件，依赖于网吧散文件更新的需要而产生
*/
//==========================================================================

#ifndef __ENCODEFILESTREAM_H__
#define __ENCODEFILESTREAM_H__
...
/// 带编码信息的标准文件流
class RKT_EXPORT EncodeFileStream : public Stream
{
protected:
	MemoryStream		m_memStream;	/// 文件真实内容
	ulong				m_encodeFlags;	/// 编码标志

public:
	EncodeFileStream();
	EncodeFileStream(const char* path);
	virtual ~EncodeFileStream();
