...
#		define PCRE_DATA_SCOPE		extern __declspec(dllexport)
#	else
...
PCRE_DATA_SCOPE pcre *pcre_compile(const char *, int, const char **,
              int *, const unsigned char *);
PCRE_DATA_SCOPE int  pcre_config(int, void *);
PCRE_DATA_SCOPE int  pcre_copy_named_substring(const pcre *, const char *,
              int *, int, const char *, char *, int);
PCRE_DATA_SCOPE int  pcre_copy_substring(const char *, int *, int, int,
              char *, int);
PCRE_DATA_SCOPE int  pcre_exec(const pcre *, const pcre_extra *,
