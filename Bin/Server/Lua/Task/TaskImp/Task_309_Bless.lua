...
-- 祝福世界
-------------------------------------------------------------------
Task_309_Bless = TaskFrameActorData:new
{
	tFinishCondition = { ConditionContactReplyCount:new{count=2} },			 -- 完成条件
}
...
-- param2 : 随机交互ID低32位
----------------------------------------------------------------------------
function Task_309_Bless:OnEventNormalProcess(tGameData)
