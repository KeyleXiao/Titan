...
-- 战争之王
-------------------------------------------------------------------
Task_611_WarResult = TaskFramePlayDotaGame:new
{
}

----------------------------------------------------------------------------
-- 在一局比赛中没有落败，并且击败数量大于5
...
----------------------------------------------------------------------------
function Task_611_WarResult:OnEventPlayDotaGame(tGameData)
	...
	-- 判断落败数量
	if tWarResultData[23] > 0 then
		return
	end
	
	-- 判断击杀数量
	if tWarResultData[14] <= 5 then
		return
	end
