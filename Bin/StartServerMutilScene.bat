...
rem start /min "客户端" ./Manager/ManagerClient.exe
...
start "监护服务器"  ./Cluster/GuardServer.exe
...
start "场景服务器" ./Server/SceneServer.exe  "sceneserver1  auth dev g "
ping 1 -n 5 -w 5000 2>nul 1>nul
start "场景服务器" ./Server/SceneServer.exe  "sceneserver2  auth dev g "
ping 1 -n 5 -w 5000 2>nul 1>nul
start "场景服务器" ./Server/SceneServer.exe  "sceneserver3  auth dev g "
rem --ping 1 -n 5 -w 5000 2>nul 1>nul
rem --start "场景服务器" ./Server/SceneServer.exe  "sceneserver4  auth dev g "
