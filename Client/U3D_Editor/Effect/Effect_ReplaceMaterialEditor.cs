...
namespace Effect
{
    [CustomEditor(typeof(Effect_ReplaceMaterial))]
    public class Effect_ReplaceMaterialEditor : Editor
    {
        Effect_ReplaceMaterial pa;
        public void OnEnable()
        {
            pa = target as Effect_ReplaceMaterial;
        }
        public override void OnInspectorGUI()
        {
            ...
            pa.TargetMaterial = EditorGUILayout.ObjectField("要替换的材质球:",pa.TargetMaterial, typeof(Material), false) as Material;
