...
namespace Effect
{
    [CustomEditor(typeof(Effect_FadeInOutMaterialColor))]
    public class Effect_FadeInOutMaterialColorEditor : Editor
    {
        Effect_FadeInOutMaterialColor pa;
        public void OnEnable()
        {
            pa = target as Effect_FadeInOutMaterialColor;
        }
