/*******************************************************************
** 文件名:	Effect_ModifSceneBrightnessEditor.cs
...
namespace Effect
{
    [CustomEditor(typeof(Effect_ModifSceneBrightness))]
    public class Effect_ModifSceneBrightnessEditor : Editor
    {
        Effect_ModifSceneBrightness pa;
