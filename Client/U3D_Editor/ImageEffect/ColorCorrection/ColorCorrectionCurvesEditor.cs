...
namespace ImageEffects
{
    ...
    class ColorCorrectionCurvesEditor : Editor
    {
        ...
        {
            m_SettingsProperty = this.serializedObject.FindProperty("model.m_Settings");
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                ((ColorCorrectionCurves)target).model.OnValidate();
            }
        ...
        void DrawNeutralTonemappingCurve()
        {
            ...
            var tonemap = ((ColorCorrectionCurves)target).model.settings.tonemapping;
            ...
            using (new EditorGUI.DisabledGroupScope(serializedObject.isEditingMultipleObjects))
            {
                ...
                if (Event.current.type == EventType.Repaint)
                {
                    ...
                    if (s_MaterialSpline == null)
                        s_MaterialSpline = new Material(Shader.Find("ImageEffect/EditorOnly/UI/Curve Background")) { hideFlags = HideFlags.HideAndDontSave };
