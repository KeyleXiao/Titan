...
namespace ImageEffects
{
    ...
    /// GlowManager编辑器
    /// </summary>
    [CustomEditor(typeof(GlowOutLineManager))]
    public class GlowOutLineManagerEditor : Editor
    {
        ...
        GlowOutLineManager tar;
        public void OnEnable()
        {
            tar = target as GlowOutLineManager;
            if (null == tar)
            {
                return;
            }
