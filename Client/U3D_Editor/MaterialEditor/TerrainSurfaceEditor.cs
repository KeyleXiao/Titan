...
internal class TerrainSurfaceEditor : ShaderGUI
{
 	private static class Styles
	{
		...
		public static GUIContent blendMask = new GUIContent("Mask", "lerp albedo1 between albedo2 color,0 only albedo1,1 only albedo2");
