...
{
    internal class XRayStandardMaterialEditor : ShaderGUI
{
    ...
    private static class Styles
    {
        ...
        public static GUIContent XRayColor = new GUIContent("XRay Color", "XRay Color");
        public static GUIContent XRayFPOW = new GUIContent("XRay FPOW", "XRay FPOW");
        public static GUIContent XRayR0 = new GUIContent("XRay R0", "XRay R0");
        ...
        public static string XRayMode = "XRaySettings";
    ...
    MaterialProperty XRayFPOW = null;
    MaterialProperty XRayR0 = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        XRayFPOW = FindProperty("_FPOW", props);
        XRayR0 = FindProperty("_R0", props); ;
    }
