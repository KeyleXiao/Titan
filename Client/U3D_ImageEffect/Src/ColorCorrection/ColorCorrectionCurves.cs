...
namespace ImageEffects
{
    ...
    public class ColorCorrectionCurves : ImageEffectNode
    {
        ...
        public ColorGradingModel model;
        ...
        void GenerateLut()
        {
            ...
            {
                GameObject.DestroyImmediate(model.bakedLut);
                model.bakedLut = null;
        ...
        public override bool ImageEffect_RenderImage(RenderTexture src, RenderTexture dst, RenderBuffer depthBuffer)
        {
        ...
        {
            DestroyImmediate(m_GradingCurves);
            DestroyImmediate(model.bakedLut);
