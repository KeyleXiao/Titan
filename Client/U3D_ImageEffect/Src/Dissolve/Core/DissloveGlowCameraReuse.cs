...
{
    public class DissloveGlowCameraReuse : DissloveGlowCamera
    {
        ...
        public void OnPreCull()
        {
            ...
            HostCamera.SetReplacementShader(base.DissloveglowOnly, "DissolveGolw");
            HostCamera.renderingPath = RenderingPath.VertexLit;
            if (dissolveGlowManager.DebugMode)
            {
