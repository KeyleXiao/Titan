...
namespace ImageEffects
{
    ...
    public class Tonemapping : ImageEffectNode 
    {
        ...
        public void Update()
        {
            if (Input.GetKeyUp(KeyCode.T) && (Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.RightControl)))
            {
	    ...
	    public override bool ImageEffect_RenderImage(RenderTexture source, RenderTexture destination, RenderBuffer depthBuffer)
        {
            ...
            //Graphics.Blit(source, destination, tonemapMaterial, 11);
