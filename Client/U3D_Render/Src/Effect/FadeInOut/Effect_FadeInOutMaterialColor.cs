...
namespace Effect
{
    public partial class Effect_FadeInOutMaterialColor : MonoBehaviour,ISaveSerializedData
    {
        ...
        private ColorFadeFinishEvent m_FinishCallBack = new ColorFadeFinishEvent();
        ...
        public void RegisterFinishEvent(UnityAction<Effect_FadeInOutMaterialColor> ev)
        {
        ...
        public void UnRegisterFinishEvent(UnityAction<Effect_FadeInOutMaterialColor> ev)
        {
            if (null != m_FinishCallBack)
            {
                if (null != ev)
        ...
        public void SetSerializedData(System.Object data)
        {
            ...
            if (RunMode == EffectRunMode.Self)
            {
                ...
                if (null == data)
                {
                    Debug.LogError("Effect_FadeInOutMaterialColor-- ConverSerializedData faild");
                    return;
                }
                m_Projectors = GetComponents<Projector>();
                ...
                {
                    Debug.LogError("Effect_FadeInOutMaterialColor-- orginalMaterialMap not match");
                    return;
                }
        ...
        public void CopyInspectorParamsTo(Effect_FadeInOutMaterialColor FromInstance)
        {
            ...
            FadeAlpha = FromInstance.FadeAlpha;
