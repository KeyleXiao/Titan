...
//                if (_emit)
//                {
//                    Vector3 offset = Random.onUnitSphere * RandomForceScale;
//                    _distanceMoved += Vector3.Distance(_t.position, _lastPosition);

//                    if (_distanceMoved >= MinControlPointDistance)
//                    {
//                        AddControlPoint(_t.position + offset);
//                        _distanceMoved = 0;
//                    }
//                    else
//                    {
//                        _controlPoints[_controlPoints.Count - 1].p = _t.position + offset;
