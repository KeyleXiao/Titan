...
namespace U3D_Render.SkinCtrl
{
    ...
    public partial class PersonSkinControl : EntitySkinControl
    {
        ...
        CreatureStateMachine m_machine = null;
        #endregion
        ...
        protected override void Start()
        {
            ...
            NotReleaseFromCache = SceneManager.Instance ? !GameLogicAPI.isMainMap(SceneManager.Instance.m_curMapID) : false;
            SkinManager.PushSkinControlToManager(this);
        }

        protected override void OnDestroy()
        {
            base.OnDestroy();         
            SkinManager.RemoveSkinControlToManager(this);
        ...
        {
            CheckMainHeroOcclusion();
            UpdatePositionToSkinManager();
            UpdateLoadingSkin();
            //if(Input.GetKeyUp(KeyCode.Alpha1))
            //{
            //    ChangeSkin(15, 0, m_machine.creaturePropety, TestOnSkinChanged);
            //}
            //if (Input.GetKeyUp(KeyCode.Alpha2))
            //{
            //    ChangeSkin(16, 0, m_machine.creaturePropety, TestOnSkinChanged);
            //}
            //if (Input.GetKeyUp(KeyCode.Alpha3))
            //{
            //    ChangeSkin(17, 0, m_machine.creaturePropety, TestOnSkinChanged);
            //}
        }
        ...
        public override void SetScale(Vector3 sca)
        {
            ...
            CharacterController controller = m_machine.controller;

            Vector3 controllercenter = controller.center;
            controllercenter.x *= tempScale.x;
            controllercenter.y *= tempScale.y;
            controllercenter.z *= tempScale.z;

            controller.center = controllercenter;
            controller.stepOffset *= tempScale.x;
            controller.radius *= tempScale.x;
            controller.height *= tempScale.y;
