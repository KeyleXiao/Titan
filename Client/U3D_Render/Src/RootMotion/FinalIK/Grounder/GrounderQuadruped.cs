...
namespace RootMotion.FinalIK {
	...
	public class GrounderQuadruped: Grounder {
		...
		/// </summary>
		[Tooltip("IK componets of the hindlegs. Can be any type of IK components.")]
		public IK[] legs;
		/// <summary>
		/// %IK components for the forelegs. Can be any type of IK components.
		/// </summary>
		[Tooltip("IK components for the forelegs. Can be any type of IK components.")]
		public IK[] forelegs;
		...
		private void UpdateForefeetRoot() {
            ...
            forefeetRoot.SetPosition(transform.position + tangent.normalized * dir.magnitude);
		}
