...
namespace RootMotion.FinalIK {
	...
	public class FBIKChain {
		...
		public class ChildConstraint {
			...
			/// </summary>
			[SerializeField] 
            protected Transform bone1;
			/// <summary>
			/// The second bone.
			/// </summary>
            [SerializeField]
            protected Transform bone2;
			...
			public void Solve() {
				...
				Vector3 direction = node2.solverPosition - node1.solverPosition;
				...
				node2.solverPosition -= offset * inverseCrossFade;
			}
		}
		...
		public void Stage1(FBIKChain[] chain) {
			...
			for (int i = 0; i < children.Length; i++) {
				...
				if (pullParentSum > 0) centroid += (childPosition - nodes[nodes.Length - 1].solverPosition) * (chain[children[i]].pull / pullParentSum);
			}
