...
namespace DG.Tweening.Core
{
    public class DOTweenSettings : ScriptableObject
    {
        ...
        public ConfigurationType SettingConfigurationType = ConfigurationType.ECT_Custom;
        public int defaultMaxTweenerCapacity = 2000;
        public int defaultMaxSequences = 100;
