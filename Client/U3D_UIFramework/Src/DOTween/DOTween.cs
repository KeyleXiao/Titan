...
namespace DG.Tweening
{
    ...
    public class DOTween
    {
        ...
        public static bool isQuitting; // Set by DOTweenComponent when the application is quitting
        ...
        public static IDOTweenInit Init(bool? recycleAllByDefault = null, bool? useSafeMode = null, LogBehaviour? logBehaviour = null)
        {
            ...
            DOTweenSettings settings = Resources.Load("DOTween/"+DOTweenSettings.AssetName) as DOTweenSettings;
        ...
        static IDOTweenInit Init(DOTweenSettings settings, bool? recycleAllByDefault, bool? useSafeMode, LogBehaviour? logBehaviour)
        {
            ...
            if (settings != null) {
                ...
                DOTween.SetTweensCapacity(settings.defaultMaxTweenerCapacity, settings.defaultMaxSequences);
            }
            // Log
