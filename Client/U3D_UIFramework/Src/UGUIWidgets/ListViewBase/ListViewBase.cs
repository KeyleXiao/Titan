...
namespace UIWidgets
{
			...
			ISubmitHandler, ICancelHandler
	{
		...
		[SerializeField]
        protected List<int> selectedIndicies = new List<int>();
        ...
        /// 左键双击
        /// </summary>
        public ListViewBaseEvent onDoubleClick = new ListViewBaseEvent();

        /// <summary>
        /// 右键点击
        /// </summary>
        public ListViewBaseEvent onRightClick = new ListViewBaseEvent();
		...
		void RemoveCallback(ListViewItem item, int index)
		{
            ...
            //////// 自定义扩展
            item.onDoubleClick.RemoveListener(OnDoubleClick);
            item.onRightClick.RemoveListener(OnRightClick);
		}
		...
		void AddCallback(ListViewItem item, int index)
		{
            ...
            //////// 自定义扩展
            item.onDoubleClick.AddListener(OnDoubleClick);
            item.onRightClick.AddListener(OnRightClick);
		}
        ...
        protected void OnDoubleClick(ListViewItem item)
        {
            onDoubleClick.Invoke(item.Index,item);
        }

        protected void OnRightClick(ListViewItem item)
        {
            onRightClick.Invoke(item.Index, item);
        }
