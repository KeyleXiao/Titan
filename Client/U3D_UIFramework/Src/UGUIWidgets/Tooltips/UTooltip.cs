    ...
    public class Tooltip
    {
        ...
        public void Initialize()
        {
            if (String.IsNullOrEmpty(Delimiter))
                Delimiter = UTooltipManager.Instance.textFieldDelimiter;
        ...
        {
            if (UTooltipManager.Instance == null) return;
            ...
            if (UTooltipManager.Instance.BlockingTooltip == this)
                UTooltipManager.Instance.BlockingTooltip = null;

            // Turn off game object.
            GameObject.SetActive(false);
            // Move the tooltip back under the proper Tooltip Container if it has a different parent.
            GameObject.transform.SetParent(UTooltipManager.Instance.TooltipContainer.transform, false);
        }
