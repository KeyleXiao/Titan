/*******************************************************************
** 文件名:	Acceptor.h 
** 版  权:	(C) 深圳冰川网络股份有限公司 2008 - All Rights Reserved
** 创建人:	陈涛 (Carl Chen)
** 日  期:	02/15/2008
** 版  本:	1.0
** 描  述:	
...
public:
	...
	bool Create(WORD wListenPort,IAcceptorHandler * pHandler,IPacker * protocol=DEFAULT_PACK)
	{
	...
	void SetName(const char * szName) { m_pListener->setName(szName); }

	Acceptor() : m_pListener(0),m_pHandler(0),m_wListenPort(0){}
