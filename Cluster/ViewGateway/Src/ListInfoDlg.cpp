...
BOOL CListInfoDlg::OnInitDialog()
{
	...
	// TODO:  在此添加额外的初始化
	CViewGatewayDlg * pServerDlg =(CViewGatewayDlg *) AfxGetApp()->m_pMainWnd;
	if (pServerDlg!=NULL)
	{
...
void CListInfoDlg::ShowListInfo(int nListType)
{
	...
	GlobalViewGateway& mainServer = pServerDlg->m_VoiceGateway;	//语音网关服务

	ClientContainer& clientList = gClientContainer;
