...
#define SERVICE_TRAYICON_TIP		_T("观战网关")			//任务栏图标Tip

// CViewGatewayDlg 对话框
class CViewGatewayDlg : public CResizingDialog
{
// 构造
public:
	CViewGatewayDlg(CWnd* pParent = NULL);	// 标准构造函数
...
// 方法
	...
	GlobalViewGateway m_VoiceGateway;	//语音网关服务
