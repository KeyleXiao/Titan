...
#define SERVICE_TRAYICON_TIP		_T("观战管理器")			//任务栏图标Tip

// CViewMngDlg 对话框
class CViewMngDlg : public CResizingDialog
{
// 构造
public:
	CViewMngDlg(CWnd* pParent = NULL);	// 标准构造函数
...
// 方法
	...
	GlobalViewMng m_VoiceServer;	//语音服务器服务
