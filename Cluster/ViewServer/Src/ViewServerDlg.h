...
#define SERVICE_TRAYICON_TIP		_T("观战Server")			//任务栏图标Tip

// CViewServerDlg 对话框
class CViewServerDlg : public CResizingDialog
{
// 构造
public:
	CViewServerDlg(CWnd* pParent = NULL);	// 标准构造函数
...
// 方法
	...
	GlobalViewServer m_VoiceGateway;	//语音网关服务
