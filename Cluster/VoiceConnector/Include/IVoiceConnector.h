...
#ifndef __INTERFACE_VOICE_SERVER_CONNECTOR_H__
#define __INTERFACE_VOICE_SERVER_CONNECTOR_H__

#include "Common.h"
#include "VoiceDef.h"

#ifndef  VOICE_API
#	ifdef VOICESERVER_EXPORTS
#		define  VOICE_API  extern "C" __declspec(dllexport)
#	else
#		define  VOICE_API  extern "C" __declspec(dllimport)
#		pragma comment(lib, MAKE_DLL_LIB_NAME(VoiceConnector))
#	endif
#endif
...
namespace Voice
{
	...
	*/
	// IVoiceConnector * CreateVoiceConnector(rkt::TimerAxis * pTimerAxis);
...
// 取得语音服务器连接器接口
VOICE_API Voice::IVoiceConnector* GetGlobalVoiceConnector();

/// 静态库版本
#if defined(_LIB) || defined(VOICE_STATIC_LIB)
#	pragma comment(lib, MAKE_LIB_NAME(VoiceConnector))
extern "C" Voice::IVoiceConnector * CreateVoiceConnector(rkt::TimerAxis * pTimerAxis);
#	define	CreateVoiceConnectorProc	CreateVoiceConnector
#else 
/// 动态库版本
typedef Voice::IVoiceConnector* (RKT_CDECL*procCreateVoiceConnector)(rkt::TimerAxis * pTimerAxis);
#	define	CreateVoiceConnectorProc	DllApi<procCreateVoiceConnector>::load(MAKE_DLL_NAME(VoiceConnector), "CreateVoiceConnector")
#endif
...
#endif//__INTERFACE_VOICE_SERVER_CONNECTOR_H__