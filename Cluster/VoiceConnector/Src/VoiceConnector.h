...
class VoiceConnector : public IVoiceConnector,public IConnectionEventHandler,public TimerHandler,public IVoiceMessageHandler
{
	enum
	{
...
public:
	...
	VoiceConnector(TimerAxis * pTimerAxis);
