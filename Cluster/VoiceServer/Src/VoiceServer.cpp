...
BEGIN_MESSAGE_MAP(CVoiceServerApp, CWinApp)
...
CVoiceServerApp::CVoiceServerApp()
{
	// TODO: 在此处添加构造代码，
...
// 唯一的一个 CVoiceServerApp 对象

CVoiceServerApp theApp;
...
BOOL CVoiceServerApp::InitInstance()
{
	...
	// 用new的方式以免对象太大堆栈不够用
	CVoiceServerDlg *pDlg = new CVoiceServerDlg;
