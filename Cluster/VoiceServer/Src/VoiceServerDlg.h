/*******************************************************************
** 文件名:	E:\Rocket\Cluster\VoiceServer\Src\VoiceServerDlg.h
** 版  权:	(C) 深圳冰川网络技术有限公司
...
#define SERVICE_TRAYICON_TIP		_T("语音服务器")			//任务栏图标Tip

// CVoiceServerDlg 对话框
class CVoiceServerDlg : public CResizingDialog
{
// 构造
public:
	CVoiceServerDlg(CWnd* pParent = NULL);	// 标准构造函数
...
// 方法
	...
	GlobalVoiceServer m_VoiceServer;	//语音服务器服务
	...
	// 语音收包带宽
	//CString m_strRecvSpeed;
	// 语音发包带宽
	//CString m_strSendSpeed;

	// 语音收包带宽
	CString m_strRecvSpeedS;
	// 语音发包带宽
	CString m_strSendSpeedS;

	// 语音收包带宽
	CString m_strRecvSpeedG;
	// 语音发包带宽
	CString m_strSendSpeedG;

	// 语音收包带宽
	CString m_strRecvSpeedC;
	// 语音发包带宽
	CString m_strSendSpeedC;
