...
struct SMsgView_GM_Handshake : public IFixMsg<SMsgView_GM_Handshake>
{
	...
	DWORD	dwServerID;		// ServerID
	WORD	wPort;			// 该Gate监听ViewServer的端口
	DWORD	dwMaxCount;		// 能承载的最大人数
	DWORD	dwCurrCount;	// 当前人数
};
...
///////////////////////////////////////////////////////////////////
// 请求观看某场战报 的回复	ENUM_MSG_VIEW_REQUEST_REPLAY_FAIL
...
enum EnumResultRequestAddPlayer
{
	...
	E_RESULT_RAP_ERR_AUTH_EXIST,	// 该ID玩家的登陆信息已存在于本Gate，但尚未登陆
...
///////////////////////////////////////////////////////////////////
// Gate通知Mng，某玩家的验证信息删除	ENUM_MSG_VIEW_AUTH_DEL
