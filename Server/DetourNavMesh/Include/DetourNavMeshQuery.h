...
public:
	...
	virtual bool PassDiameter(const dtPolyRef refSelf, const dtPolyRef refNeighbour) const;
#else
...
private:
	...
	class dtNodePool* m_childNodePool;	///< Pointer to child node pool. 动态障碍相关
	class dtNodeQueue* m_openList;		///< Pointer to open list queue.
    class dtNodeQueue* m_childOpenList; ///< Pointer to open list queue.
};
