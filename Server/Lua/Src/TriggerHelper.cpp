...
{
    return TriggerManager::getInstance().deleteTrigger(nTriggerID);
}
...
{
    return TriggerManager::getInstance().createTimerTrigger(nSceneID, szCallFunc, nInterval, nTimes);
}
...
{
    return TriggerManager::getInstance().createDateTrigger(nSceneID, szCallFunc, nYear, nMonth, nDay, nHour, nMinute, nWDay);
}
...
{
    return TriggerManager::getInstance().createLoginTrigger(nSceneID, szCallFunc);
}
...
{
    return TriggerManager::getInstance().createWarPersonTaskTrigger(nSceneID, szCallFunc);
}
...
{
	return TriggerManager::getInstance().createNPCTrigger(nSceneID, szCallFunc);
}
...
{
	return TriggerManager::getInstance().createNPCFuncTrigger(nSceneID, szCallFunc);
}
...
{
	return TriggerManager::getInstance().createActorTaskTrigger(nSceneID, szCallFunc);
}