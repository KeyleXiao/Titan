...
///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	#	pragma comment(lib, MAKE_LIB_NAME(OSSLogServer))
	...
	#	define	CreateOSSLogServerProc	DllApi<procCreateOSSLogServer>::load(MAKE_DLL_NAME(OSSLogServer), "CreateOSSLogServer")
#endif
