...
struct IOSSLogService
{
	...
	*/
	virtual void addActorForgeLog(int nGameWorldID, DWORD dwUserID, DWORD dwActorID, BYTE nOperateType, DWORD dwGoodID,const char * szGoodName ,int nTime,const char * szForgeDesc, DWORD dwReserve = 0) = 0;
	...
	*/
	virtual void addTaskInfo(int nTaskID, int nAcceptNum, int nFinishNum, int nGiveUpNum) = 0;
};
