...
// 定义
class CSchemeHeroCard : public ISchemeHeroCard, public ISchemeUpdateSink, public CSchemeCache<CSchemeHeroCard>
{
...
public:
	...
	*/
    virtual bool                                    isHaveThisCard( int nCardID );
