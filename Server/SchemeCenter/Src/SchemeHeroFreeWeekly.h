...
class CSchemeHeroFreeWeekly : public ISchemeHeroFreeWeekly, public ISchemeUpdateSink, public CSchemeCache<CSchemeHeroFreeWeekly>
{
public:
	/////////////////////////////////ISchemeHeroFreeWeekly/////////////////////////////////////////
	virtual int				GetFreeHeroListByLv( int arrayFreeHero[], int arrayLen, int nLv );

	virtual bool			IsFreeHeroListChanged( int nLv );
