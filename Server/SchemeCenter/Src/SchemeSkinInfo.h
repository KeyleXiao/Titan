...
// 定义
class CSchemeSkinInfo : public ISchemeSkinInfo, public ISchemeUpdateSink, public CSchemeCache<CSchemeSkinInfo>
{
...
public:
	...
	@return  
	*/
	virtual SkinInfoScheme_S*						getSkinShemeInfo(int nSkinID);
...
private:
	// 皮肤ID为索引
	typedef std::map<int, SkinInfoScheme_S> TMAP_SKININFOSCHEME;
