...
#ifndef __SERVER_SERVERGLOBAL_INCLUDE_IDBENGINESERVICE_H__
#define __SERVER_SERVERGLOBAL_INCLUDE_IDBENGINESERVICE_H__
...
#endif  // __SERVER_SERVERGLOBAL_INCLUDE_IDBENGINESERVICE_H__
