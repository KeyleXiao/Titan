...
public:
    ...
    */
    ...
    @param pszServiceSchemeName: Service配置名称
    */
    virtual void            stop_service(const char * szServiceSchemeName);

	/* 停止服务
    @param serviceID:服务ID
    */
    virtual void            stop_service(SERVICE_ID  serviceID);
    ...
    /* 校验账号有效性*/
    virtual bool            checkAccount(const char * pszUserName, const char * pszPassword);
