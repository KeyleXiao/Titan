...
class COSSLogService_Proxy : public IOSSLogService
{
public:
    ////////////////// IOSSLogService ////////////////////////////////////////////////////////
	/** 记录文字型日志
	...
	*/
	virtual void addTicketLog(int nGameWorldID, DWORD dwMaster, int nTarget, int nNum, WORD wApproach, int nTime, const char * szRemark, DWORD dwReserve);
    ...
    @ param dwReserve  : 保留数据（用于标识一些特别的记录）
	*/
    virtual void transTickLog(int nGameWorldID, DWORD dwMaster, int nTarget, int nNum, WORD wApproach, int nTime, const char * szRemark, DWORD dwReserve);
	...
	@ param dwReserve  : 保留数据（用于标识一些特别的记录）
	*/
	virtual void addMoneyLog(int nGameWorldID, DWORD dwMaster, int nTarget, int nNum, WORD wApproach, int nTime, const char * szRemark, DWORD dwReserve);
	...
	@ param dwReserve  : 保留数据（用于标识一些特别的记录）
	*/
	virtual void transMoneyLog(int nGameWorldID, DWORD dwMaster, int nTarget, int nNum, WORD wApproach, int nTime, const char * szRemark, DWORD dwReserve);
	...
	@ param dwReserve  : 保留数据（用于标识一些特别的记录）
	*/
	virtual void addBindMoneyLog(int nGameWorldID, DWORD dwMaster, int nTarget, int nNum, WORD wApproach, int nTime, const char * szRemark, DWORD dwReserve);
	...
	@ param dwReserve  : 保留数据（用于标识一些特别的记录）
	*/
	virtual void transBindMoneyLog(int nGameWorldID, DWORD dwMaster, int nTarget, int nNum, WORD wApproach, int nTime, const char * szRemark, DWORD dwReserve);
