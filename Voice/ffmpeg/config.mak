...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-avdevice --disable-avfilter --disable-network --disable-everything --enable-static --disable-debug --disable-stripping --disable-mmx --enable-shared --disable-pthreads --disable-w32threads --disable-os2threads --enable-decoder=h264
prefix=/usr/local
...
LD_PATH=-L
DLLTOOL=dlltool
LDFLAGS=  -Wl,--nxcompat -Wl,--dynamicbase -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
SHFLAGS=-shared -Wl,--output-def,$$(@:$(SLIBSUF)=.orig.def) -Wl,--out-implib,$(SUBDIR)lib$(SLIBNAME:$(SLIBSUF)=.dll.a) -Wl,--enable-runtime-pseudo-reloc -Wl,--enable-auto-image-base -Wl,-Bsymbolic -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
YASMFLAGS=
BUILDSUF=
PROGSSUF=
